...
var descriptor = databaseDescriptor{
	shippers: shippersTableDescriptor{
		...
		shipperId: columnDescriptor{
			columnID:             "shipper_id",
			columnType:           spansql.Type{Array: false, Base: 4, Len: 63, ProtoRef: ""},
			notNull:              true,
			allowCommitTimestamp: false,
		},
		createTime: columnDescriptor{
			columnID:             "create_time",
			columnType:           spansql.Type{Array: false, Base: 7, Len: 0, ProtoRef: ""},
			notNull:              true,
	...
	sites: sitesTableDescriptor{
		...
		latitude: columnDescriptor{
			columnID:             "latitude",
			columnType:           spansql.Type{Array: false, Base: 2, Len: 0, ProtoRef: ""},
			notNull:              false,
			allowCommitTimestamp: false,
		},
	...
	shipments: shipmentsTableDescriptor{
		...
		annotations: columnDescriptor{
			...
			columnType:           spansql.Type{Array: true, Base: 4, Len: 9223372036854775807, ProtoRef: ""},
			notNull:              true,
			allowCommitTimestamp: false,
		},
	},
